...
class VTI_VTISeoCore_Block_Googleanalytics_Ua extends Mage_GoogleAnalytics_Block_Ga
{
...
<!-- END UNIVERSAL ANALYTICS CODE -->\r\n";
    ...
    {
        return Mage::getStoreConfig('vtiseocore/googleanalytics/enable_demographics');
    }

    public function getAdditionalTrackingCode()
    {
        return Mage::getStoreConfig('vtiseocore/googleanalytics/additional_tracking_code');
    }
}