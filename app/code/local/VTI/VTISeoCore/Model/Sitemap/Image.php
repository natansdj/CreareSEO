...
class VTI_VTISeoCore_Model_Sitemap_Image
{
    ...
    public function create()
    {
        ...
        foreach ($stores as $store) {
            ...
            if ( ! Mage::getStoreConfigFlag('vtiseocore/imagesitemap/enabled', $storeId)) {
                continue;
            }

            $filePath = Mage::getBaseDir('media') . DS . Mage::getStoreConfig('vtiseocore/imagesitemap/path',
                    $storeId);
